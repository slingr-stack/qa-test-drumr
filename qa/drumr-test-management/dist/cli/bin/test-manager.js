...
const open_js_1 = require("../commands/tests/open.js");
const setup_js_1 = require("../commands/tests/setup.js");
function printHelp() {
...
async function main() {
    ...
    switch (command) {
        case 'open': {
            ...
            await (0, open_js_1.openTests)(process.cwd(), { port, noOpen });
            break;
        }
        case 'setup': {
            await (0, setup_js_1.setupTests)(process.cwd());
            break;
        }
        case 'help':
        case '-h':
